 ...
 * @see https://android.googlesource.com/platform/packages/apps/UnifiedEmail/+/42fe486/src/com/android/mail/ui/ButteryProgressBar.java
 */
public class ButteryProgressBar extends View {
    ...
    public ButteryProgressBar(Context c, AttributeSet attrs) {
        ...
        mBarColor = c.getResources().getColor(R.color.progressbar_color);
